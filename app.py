...
#Function that connects to the database and fetches data
...
st.write("Ask me a question in plain English, and I'll help you turn it into SQL.")
...
#When the form is submitted, OpenAI is called and SQL query will be showed.
if submitted:
